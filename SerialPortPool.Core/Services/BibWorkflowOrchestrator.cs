...
// ===================================================================
...

    {
        ...
        _logger.LogInformation("🚀 PRODUCTION START PHASE: {ClientId}", clientId);
...

        {
            ...
            _logger.LogInformation("🚀 WORKFLOW STARTING: {ClientId}", clientId);
...

            {
                ...
                var logsMessage = $"Start Phase - {commandResult.IsSuccess} - {commandResult.Command.ToString()} - {commandResult.Response.ToString()} - {commandResult.StartTime.ToString()} - {commandResult.Duration.ToString()}";

                bibLogger.LogBibExecution(LogLevel.Information, logsMessage.Replace("\n", "⏎").Replace("\r", "↵"));
...

    {
        ...
        _logger.LogInformation("🚀 PRODUCTION TEST PHASE: {ClientId}", clientId);
...

        {
...

            {
                ...
                var logsMessage = $"Tests Loop - {commandResult.IsSuccess} - {commandResult.Command.ToString()} - {commandResult.Response.ToString()} - {commandResult.StartTime.ToString()} - {commandResult.Duration.ToString()}";
...

    {
       ...
       // 🆕 SPRINT 12/14: Add structured logging
        ...
        _logger.LogInformation("🚀 PRODUCTION STOP PHASE: {ClientId}", clientId);
...

        {
...

            {
...

                {
                    ...
                    var logsMessage = $"Stop phase - {commandResult.IsSuccess} - {commandResult.Command.ToString()} - {commandResult.Response.ToString()} - {commandResult.StartTime.ToString()} - {commandResult.Duration.ToString()}";
