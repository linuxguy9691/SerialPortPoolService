...
public class HardwareSimulationTests
{
    ...
    public void HardwareSimulationHelper_ValidateSimulationConfig_WithInvalidConfig_ReturnsErrors()
    {
        ...
        var invalidConfig = new HardwareSimulationConfig
        {
            ...
            StartTrigger = new StartTriggerConfig(), // Valid instead of null
            StopTrigger = new StopTriggerConfig(),   // Valid instead of null
            CriticalTrigger = new CriticalTriggerConfig() // Valid instead of null
        };
        ...
        // Assert
        Assert.True(errors.Count >= 1); // At least speed multiplier error
        Assert.Contains(errors, e => e.Contains("Speed multiplier"));
    }
